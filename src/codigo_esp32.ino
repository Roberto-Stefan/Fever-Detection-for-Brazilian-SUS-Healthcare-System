/*
 * =====================================================================
 * SISTEMA DE CONTAGEM BIDIRECIONAL DE PESSOAS - VERSÃO 6800
 * =====================================================================
 * 
 ...
 * - LED acende quando há pelo menos uma pessoa no ambiente
 ...
 * 2. 2x Displays de 7 segmentos (mostram números de 0 a 99)
 * 3. 2x Sensores infravermelho na porta da FRENTE
 * 4. 1x Sensor infravermelho no FUNDO (externo)
 * 5. 1x LDR (sensor de luz) no FUNDO (interno)
 * 6. 1x LED branco (indica presença)
 * 7. 1x Botão (reset manual)
 * 8. Resistores diversos
 * 
 * =====================================================================
 ...
 * 
 * =====================================================================
 * FUNCIONAMENTO BÁSICO (para leigos):
 * 
...
// São como as "perninhas" que controlam cada pedaço do número
